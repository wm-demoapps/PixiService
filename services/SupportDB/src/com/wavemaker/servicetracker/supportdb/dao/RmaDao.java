...
/**
 * Specifies methods used to obtain and modify Rma related information
 * which is stored in the database.
 */
@Repository("SupportDB.RmaDao")
public class RmaDao extends WMGenericDaoImpl<Rma, Integer> {
