...
/**
 * Specifies methods used to obtain and modify TimeSlot related information
 * which is stored in the database.
 */
@Repository("SupportDB.TimeSlotDao")
public class TimeSlotDao extends WMGenericDaoImpl<TimeSlot, Integer> {
