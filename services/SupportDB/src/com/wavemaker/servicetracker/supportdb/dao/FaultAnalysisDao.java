...
/**
 * Specifies methods used to obtain and modify FaultAnalysis related information
 * which is stored in the database.
 */
@Repository("SupportDB.FaultAnalysisDao")
public class FaultAnalysisDao extends WMGenericDaoImpl<FaultAnalysis, Integer> {
