...
/**
 * Specifies methods used to obtain and modify Engineer related information
 * which is stored in the database.
 */
@Repository("SupportDB.EngineerDao")
public class EngineerDao extends WMGenericDaoImpl<Engineer, Integer> {
