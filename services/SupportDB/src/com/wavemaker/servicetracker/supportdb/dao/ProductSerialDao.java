...
/**
 * Specifies methods used to obtain and modify ProductSerial related information
 * which is stored in the database.
 */
@Repository("SupportDB.ProductSerialDao")
public class ProductSerialDao extends WMGenericDaoImpl<ProductSerial, Integer> {
