...
/**
 * Specifies methods used to obtain and modify PartStockType related information
 * which is stored in the database.
 */
@Repository("SupportDB.PartStockTypeDao")
public class PartStockTypeDao extends WMGenericDaoImpl<PartStockType, Integer> {
