...
/**
 * Specifies methods used to obtain and modify ServiceMode related information
 * which is stored in the database.
 */
@Repository("SupportDB.ServiceModeDao")
public class ServiceModeDao extends WMGenericDaoImpl<ServiceMode, Integer> {
