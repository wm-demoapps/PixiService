...
/**
 * Specifies methods used to obtain and modify PartSale related information
 * which is stored in the database.
 */
@Repository("SupportDB.PartSaleDao")
public class PartSaleDao extends WMGenericDaoImpl<PartSale, Integer> {
