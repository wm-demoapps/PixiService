...
/**
 * Specifies methods used to obtain and modify PartMaterial related information
 * which is stored in the database.
 */
@Repository("SupportDB.PartMaterialDao")
public class PartMaterialDao extends WMGenericDaoImpl<PartMaterial, Integer> {
