...
/**
 * Specifies methods used to obtain and modify Rating related information
 * which is stored in the database.
 */
@Repository("SupportDB.RatingDao")
public class RatingDao extends WMGenericDaoImpl<Rating, Integer> {
