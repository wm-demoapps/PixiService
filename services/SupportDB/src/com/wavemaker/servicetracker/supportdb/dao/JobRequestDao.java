...
/**
 * Specifies methods used to obtain and modify JobRequest related information
 * which is stored in the database.
 */
@Repository("SupportDB.JobRequestDao")
public class JobRequestDao extends WMGenericDaoImpl<JobRequest, Integer> {
