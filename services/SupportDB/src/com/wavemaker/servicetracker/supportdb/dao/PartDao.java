...
/**
 * Specifies methods used to obtain and modify Part related information
 * which is stored in the database.
 */
@Repository("SupportDB.PartDao")
public class PartDao extends WMGenericDaoImpl<Part, Integer> {
