...
/**
 * Specifies methods used to obtain and modify PaymentType related information
 * which is stored in the database.
 */
@Repository("SupportDB.PaymentTypeDao")
public class PaymentTypeDao extends WMGenericDaoImpl<PaymentType, Integer> {
